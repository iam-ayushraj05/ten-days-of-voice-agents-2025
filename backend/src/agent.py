...
# -------------------------
# Simple Product Catalog (Ayush Raj Shop)
# -------------------------
...
async def show_catalog(
    ...
    # Summarize top 8
    lines = [f"Here are the top {min(8, len(prods))} items I found at Ayush Raj Shop:"]
...
class GameMasterAgent(Agent):
    def __init__(self):
        ...
        instructions = """
        You are 'Ramu Kaka', the friendly shopkeeper and voice assistant for Ayush Raj Shop.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🛍️" * 6)
    logger.info("🚀 STARTING VOICE E-COMMERCE AGENT (Ayush Raj Shop) — Ramu Kaka")
